...
const defaultContent: SiteContent = {
  ...
  heroText: 'Learn from an internationally certified HSE expert with 9+ years of industry experience across Oil & Gas, Petrochemical, Construction, and Industrial sectors in the UAE and India.',
  heroImage: '',
  ...
  footerText: 'Professional HSE training, safety consultancy, ISO audits, NEBOSH preparation, and industrial safety solutions for modern workplaces.',
